...
@interface redChipListSegmentView()
...
@implementation redChipListSegmentView
-(instancetype)initWithFrame:(CGRect)frame titles:(NSArray *)titleArray btn_w:(CGFloat)btn_w clickBlick:(btnClickBlock)block{
    ...
    if (self) {
        ...
        //        _titleNomalColor=[Toolkit getColor:hex_606060];
...
-(void)btnClick:(UIButton *)btn{
    ...
    CGFloat maxOffsetX= _bgScrollView.contentSize.width-windowContentWidth + _btn_w;
